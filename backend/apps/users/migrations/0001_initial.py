    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('patient', 'Pasiyent'), ('psychologist', 'Psixoloq')], default='patient', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('onboarding_status', models.CharField(choices=[('not_started', 'Başlanmayıb'), ('assessment_done', 'Qiymətləndirmə Tamamlandı'), ('psychologist_selected', 'Psixoloq Seçildi'), ('completed', 'Tamamlandı')], default='not_started', max_length=30)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='patient_profile', to=settings.AUTH_USER_MODEL)),
                ('psychologist', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patients', to='users.psychologistprofile')),
            ],
            options={
